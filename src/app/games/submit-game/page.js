...
export default function Page() {
  async function handleSubmit(formData) {
    ...
    db.query(
      `INSERT INTO games (title, img_url, description, genre, year_released, score, platform, developer) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
      [
        title,
        img_url,
        description,
  ...
  return (
    <div className="text-black">
      <marquee scrolldelay="100">
        <h3>
          Think you have what it takes? Submit a{" "}
          <span className={`${cuteFont.className} text-xl`}>game</span>
        </h3>
      </marquee>
      <form
        action={handleSubmit}
